...
#import "GameCubeSystemLanguageViewController.h"

#import "Core/Config/MainSettings.h"

@interface GameCubeSystemLanguageViewController ()

@end

@implementation GameCubeSystemLanguageViewController {
...
- (void)viewWillAppear:(BOOL)animated {
  ...
  _lastSelected = Config::Get(Config::MAIN_GC_LANGUAGE);
